...
export const validateCreateKeyboardV = [
...
export const validateUpdateKeyboardV = [
...
export const validateIdKeyboardV = [param('id').isMongoId().withMessage(errorUUID), expressValidation];
